...
const apiResponse = _.cloneDeep(
  require("../../fixtures/api-responses/contact-put.json").contact
);
...
module.exports = ctxMock => {
  ...
  expect(ctxMock.metric.increment.mock.calls[0]).toEqual([
    ...
    [
      "method:PUT",
      "url:https://api.aircall.io/v1/contacts/800777/",
      "status:200",
      "statusGroup:2xx",
      "endpoint:PUT https://api.aircall.io/v1/contacts/800777/"
    ]
  ]);
